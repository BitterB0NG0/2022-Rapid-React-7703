...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    new JoystickButton(mainJoystick, 1).whenPressed(new SpinIntakeMotor(intakeSubsystem, 1));
    new JoystickButton(mainJoystick, 1).whenReleased(new SpinIntakeMotor(intakeSubsystem, 0));
  }
